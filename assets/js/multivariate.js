...
$('h4.bar-chart-title').text('Fuel consumption (tons) in Beijing, 2004-2013');

// if (ourDataset == 0) {
//   ourArray = Beijing;
//   $('h4.bar-chart-title').text('Fuel consumption (tons) in Beijing, 2004-2013');
// }else if(ourDataset == 1) {
//   ourArray = Shanghai;
//   $('h4.bar-chart-title').text('Fuel consumption (tons) in Shanghai, 2004-2013');
// }else {
//   ourArray = Guangdong;
//   $('h4.bar-chart-title').text('Fuel consumption (tons) in Guangdong, 2004-2013');
// };
...
// Set up a controls box that can be style with css with .controls{}
  ...
  $('.controls').append('<div><h6>Get data from :</h6><a class="data_from_beijing">Beijing</a><a class="data_from_shanghai">Shanghai</a><a class="data_from_guangdong">Guangdong</a></div>')
...
// Set the initial state of our on/off switches
  ...
  $('.data_from_beijing').addClass('active');
...
// Normalized Category Size
  ...
  // Change dataset
  $(document).on('click', '.data_from_beijing', function(){
    ourArray = Beijing;
    universalController();
    $('h4.bar-chart-title').text('Fuel consumption (tons) in Beijing, 2004-2013');
    $('.data_from_beijing').addClass('active').siblings().removeClass('active');
  })
  $(document).on('click', '.data_from_shanghai', function(){
    ourArray = Shanghai;
    universalController();
    $('h4.bar-chart-title').text('Fuel consumption (tons) in Shanghai, 2004-2013');
    $('.data_from_shanghai').addClass('active').siblings().removeClass('active');

  })
  $(document).on('click', '.data_from_guangdong', function(){
    ourArray = Guangdong;
    universalController();
    $('h4.bar-chart-title').text('Fuel consumption (tons) in Guangdong, 2004-2013');
    $('.data_from_guangdong').addClass('active').siblings().removeClass('active');
    // $(".bar-chart").remove();
